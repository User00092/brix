...
from brix.policies import MAX_TREE_DEPTH
...
def tools_for(agent: Agent) -> list[dict[str, Any]]:
    tools = [
        function("list_agents", "List agents visible in this Brix session.", {}, []),
        function(
            "get_agent",
    ...
    return [
        {
            "type": "namespace",
            "name": "brix",
            "description": "Delegate, observe, and verify work in the current Brix hierarchy.",
            "tools": tools,
        }
    ]
